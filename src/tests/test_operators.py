...
if __name__ == "__main__":
    ...
    if test_type == "mutator":
        prompt, mutated = operator.mutate_prompt(prompt="Timely updates will strengthen our case for continued funding; keep the publication pipeline moving",
        ...
        child_prompt = operator.crossover_prompts(
            parent_prompt1,
            parent_prompt2,
            crossover_rate=0.9,
            n_children=1,
